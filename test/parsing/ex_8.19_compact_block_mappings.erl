-module('ex_8.19_compact_block_mappings').
    ...
    ?_assertMatch(
      {yamerl_parser,
        ...
        [
          ...
          {yamerl_doc_end,3,16},
          {yamerl_collection_end,3,16,block,sequence},
          {yamerl_collection_end,3,16,block,mapping},
          {yamerl_collection_end,3,16,block,mapping},
          {yamerl_scalar,3,11,
          ...
          {yamerl_collection_end,2,16,block,mapping},
          {yamerl_scalar,2,12,
          ...
          {yamerl_collection_end,1,14,block,mapping},
          {yamerl_scalar,1,8,
